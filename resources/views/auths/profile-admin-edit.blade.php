                    ...
                    <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#personalDetails" role="tab">
                                <i class="fas fa-home"></i> Thông tin chi tiết
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card-body p-4">
                    <div class="tab-content">
                        <div class="tab-pane active" id="personalDetails" role="tabpanel">
                            <form action="{{ route('admin.profile.update', $user->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="lastnameInput" class="form-label">Ảnh đại diện</label>
                        ...
                        <div class="tab-pane" id="changePassword" role="tabpanel">
                            <form action="{{ route('password.sendConfirmationCode') }}" method="POST">
                                @csrf
                                <div class="row g-2">
                                    <div class="col-lg-4">
                                        <div>
                                            <label for="oldpasswordInput" class="form-label">Nhập email*</label>
                                            <input type="text" class="form-control" id="oldpasswordInput" name="email"
                            ...
                            <form action="{{ route('password.confirmChange') }}" method="POST">
                                @csrf
                                <div class="row g-2">
                                    <div class="col-lg-4">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="confirmation_code"
                                                placeholder="Nhập mã xác nhận gửi đến email">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-4">
