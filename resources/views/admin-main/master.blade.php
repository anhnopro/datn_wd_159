...
<head>
    ...
    <style>
        /* Tạo vị trí cố định cho pop-up thông báo */
        .alert-overlay {
            position: fixed;
            top: 20px;
            left: 50%;
...
<body>
    ...
    <div id="layout-wrapper">
        ...
        <header id="page-topbar">
            @include('admin-main.layouts.header')
        </header>
        ...
        <div class="app-menu navbar-menu">
            @include('admin-main.layouts.navbar')
        </div>
        <!-- Left Sidebar End -->
        ...
        <div class="main-content">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="h-100">
                                ...
                                @if (session('success'))
                                    <div class="alert alert-success alert-overlay" role="alert" id="success-alert">
                                        {{ session('success') }}
                                    </div>
                                @endif

                                @if ($errors->any())
                                    <div class="alert alert-danger alert-overlay" role="alert" id="error-alert">
                                        <ul>
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2">
                                                            <a href="apps-ecommerce-product-details.html"
                                                                ...
                                                                <img src="/admin/assets/images/products/img-8.png"
                                                            ...
                                                            <a href="apps-ecommerce-product-details.html"
                                                                class="bg-light rounded p-1">
                                                                <img src="/admin/assets/images/products/img-10.png"
                                                                    alt="" class="img-fluid d-block" />
                                                            </a>
                                                        </div>
                                                                ...
                                                                <div class="d-flex">
                                                                    <div class="flex-shrink-0 avatar-sm">
                                                                        <div class="avatar-title bg-light rounded">
                                                                            <img src="/admin/assets/images/companies/img-1.png"
                                                                                alt="" height="30">
                                                                        </div>
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <div class="card border border-dashed shadow-none">
                                                            <div class="card-body">
                                                                <div class="d-flex">
                                                                    <div class="flex-shrink-0 avatar-sm">
                                                                        <div class="avatar-title bg-light rounded">
                                                                            <img src="/admin/assets/images/companies/img-8.png"
                                                                                alt="" height="30">
                                                                        </div>
                                                                    </div>
                                                                    <div class="flex-grow-1 ms-3">
            ...
            <footer class="footer">
                @include('admin-main.layouts.footer')
            </footer>
        </div>
        <!-- end main content-->
